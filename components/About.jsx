...
import AudreyImg from "../public/assets/audrey.webp";
    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <p className="uppercase text-xl tracking-widest text-[#BB6464]">
            About
          </p>
          <h2 className="py-4">Who I Am</h2>
          <p className="py-2 text-gray-600">
            I have spent the last 4 years working in Trust and Safety for
            Youtube and Apple. Enforcing policies and guidelines to ensure
